...
namespace PussyDetector
{
    public static class DefaultSets
    {
        ...
        private static void Initialze()
        {
            ...
            int validationSetSize = (int)Math.Round(((double)Settings.Default.ValidationPercent / 100.0) * setSize);
            ...
            validationSetSize = (int)Math.Round(((double)Settings.Default.ValidationPercent / 100.0) * setSize);
