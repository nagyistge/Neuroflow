...
namespace NeoComp.Evolution.GA
{
    public static class SequenceOperators
    {
        ...
        //    Probability pointMutationChance,
        //    Func<T, T> pointMutationMethod,
        //    IntRange sequenceSizeMutationChunkSize,
        //    Probability sequenceSizeMutationChance,
        //    Func<int, IEnumerable<T>> newSequenceGeneratorMethod)
        //{
        //    Contract.Requires(pointMutationMethod != null);
        //    Contract.Requires(newSequenceGeneratorMethod != null);

        //    var chunks = ToChunks(sequence, sequenceSizeMutationChunkSize);

        //    chunks = Mutate(chunks, pointMutationChance, pointMutationMethod, sequenceSizeMutationChunkSize, sequenceSizeMutationChance, newSequenceGeneratorMethod);

        //    return ToSequence(chunks);
        //}

        //private static IEnumerable<IEnumerable<T>> Mutate<T>(
        //    IEnumerable<IEnumerable<T>> chunks,
        //    Probability pointMutationChance,
        //    Func<T, T> pointMutationMethod,
        //    IntRange sequenceSizeMutationChunkSize,
        //    Probability sequenceSizeMutationChance,
        ...
        //    foreach (var chunk in chunks)
        //    {
        //        if (sequenceSizeMutationChance && RandomGenerator.FiftyPercentChance)
        //        {
        ...
        //        if (pointMutationChance.HasChance)
        //        {
        //            yield return DoPointMutation(chunk, pointMutationChance, pointMutationMethod);
        //        }
        //        else
        //        {
        //            yield return chunk;
        ...
        //            yield return newSequenceGeneratorMethod(sequenceSizeMutationChunkSize.PickRandomValue());
        //        }
        //    }
        //}

        //static IEnumerable<T> DoPointMutation<T>(IEnumerable<T> sequence, Probability pointMutationChance, Func<T, T> pointMutationMethod)
        //{
        //    foreach (var item in sequence)
        //    {
        //        if (pointMutationChance)
        //        {
        //            //Console.WriteLine("POINT");
        //            yield return pointMutationMethod(item);
        //        }
        //        else
        //        {
        //            yield return item;
        ...
        //static IEnumerable<IEnumerable<T>> ToChunks<T>(IEnumerable<T> sequence, IntRange chunkSize)
        //{
        //    var enumerator = new ObservableEnumerator<T>(sequence.GetEnumerator());
