...
namespace Neuroflow.Core.ComputationalNetworks.Architectures
{
        ...
        where T : struct
    {
        ...
        protected abstract IFactory<ComputationConnection<T>> OutputInterfaceConnectionFactory { get; }
        ...
        where T : struct
    {
        ...
        protected override IFactory<ComputationConnection<T>> OutputInterfaceConnectionFactory
        {
            get 
            {
                Contract.Ensures(Contract.Result<IFactory<ComputationConnection<T>>>() != null);
                return null;
            }
        }
