...
namespace ImgNoise.Training
{
    internal static class Program
    {
        ...
        private static void Begin()
        {
            ...
            var trainingBatcher = new ScriptCollectionBatcher(trainingStrat, trainingProv, 150, 500);

            var validProv = CreateProvider(1000, recurrent);
            var validStrat = new MonteCarloBatchingStrategy();
            var validBatcher = new ScriptCollectionBatcher(validStrat, validProv, 25, 5000);
