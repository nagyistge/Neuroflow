...
namespace NeoComp.Networks.Computational
{
        ...
        where T : struct
    {
        ...
        protected internal override bool OverrideNetworkFactoryEntry(ModifyableNetworkFactoryEntry<ComputationalNode<T>, ComputationalConnection<T>> factoryEntry, HashSet<int> occupiedNodeIndexes)
        {
        ...
        protected internal override bool OverrideNetworkEntry(ModifyableNetworkEntry<ComputationalNode<T>, ComputationalConnection<T>> networkEntry, HashSet<int> occupiedNodeIndexes)
        {
        ...
        private void RemoveIORecurrentConnFactories(IList<ConnectionFactoryEntry<ComputationalConnection<T>>> entryFactColl)
        {
        ...
        private void RemoveIORecurrentConns(IList<ConnectionEntry<ComputationalConnection<T>>> entryFactColl)
        {
            for (int idx = 0; idx < entryFactColl.Count; idx++)
            {
                var entry = entryFactColl[idx];
