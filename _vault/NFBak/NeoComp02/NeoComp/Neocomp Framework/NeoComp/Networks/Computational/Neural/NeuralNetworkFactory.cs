...
namespace NeoComp.Networks.Computational.Neural
{
    public class NeuralNetworkFactory : ComputationalNetworkFactory<double>
    {
        ...
        protected internal override bool OverrideNetworkEntry(ModifyableNetworkEntry<ComputationalNode<double>, ComputationalConnection<double>> networkEntry, HashSet<int> occupiedNodeIndexes)
        {
        ...
        private void CheckConns(IList<ConnectionEntry<ComputationalConnection<double>>> collection)
        {
