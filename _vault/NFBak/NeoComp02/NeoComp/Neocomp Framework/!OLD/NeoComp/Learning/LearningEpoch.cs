...
namespace NeoComp.Learning
{
    public class LearningEpoch : SynchronizedObject, IEpoch
    {
        ...
        LearningScriptBatchExecution validationExec;

        public LearningScriptBatchExecution LearningExecution { get; private set; }

        public LearningScriptBatcher Batcher { get; private set; }

        public LearningScriptBatcher ValidationBatcher { get; private set; }
