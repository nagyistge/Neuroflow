...
{
    [Serializable]
    public class MLABuilder<T> : ILayeredArchitectureBuilder<T>
    {
        public MLABuilder(bool wired, ConnectionLayerDefinition<T> connectionLayerDefinition, int inputInterfaceLength, params NodeLayerDefinition<T>[] nodeLayerDefinitions)
        {
