...
namespace NeoComp.Networks
{
    public abstract class NetworkFactory<TNode, TConnection> : SynchronizedObject
    {
        ...
        protected internal virtual bool OverrideNetworkFactoryEntry(ModifyableNetworkFactoryEntry<TNode, TConnection> factoryEntry, HashSet<int> occupiedNodeIndexes)
        {
            Contract.Requires(factoryEntry != null);
            Contract.Requires(occupiedNodeIndexes != null);

            return true;
        }

        protected internal virtual bool OverrideNetworkEntry(ModifyableNetworkEntry<TNode, TConnection> networkEntry, HashSet<int> occupiedNodeIndexes)
        {
