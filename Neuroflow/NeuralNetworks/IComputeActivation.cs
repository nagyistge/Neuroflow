...
namespace Neuroflow.NeuralNetworks
{
    public interface IComputeActivation : IComputationStateFactory
    {
        ...
        void ComputeGradientsRTLR(Marshaled<RTLRLayerInfo[][]> inputLayerInfos, Marshaled<IDeviceArray[]> netValueDerivates, Marshaled<RTLRComputationData> data, Marshaled<IDeviceArray[]> valueRelatedPBuffs, IDeviceArray outputs, IDeviceArray desiredOutputs);
