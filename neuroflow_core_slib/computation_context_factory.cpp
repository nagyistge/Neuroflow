...
#include "cpp/cpp_cc_factory_adapter.h"
#include "ocl/ocl_cc_factory_adapter.h"
#include "cc_init_pars.h"

USING

computation_context_factory computation_context_factory::_singleton = computation_context_factory();
