...
namespace nf
{
    struct multilayer_perceptron : contexted<computation_context>, virtual nf_object
    {
        ...
        typedef std::vector<row_numbered<layer_ptr>> ordered_layer_collection_t;

        nf::gradient_computation_method gradient_computation_method() const;
    ...
    private:
        ...
        multilayer_perceptron(const computation_context_ptr& context, layer_collection_t& layers, const mlp_init_pars* properties);
        ...
        ordered_layer_collection_t _layers;
